 ...
 * 
 */
@WebService(name = "TravelItineraryReadPortType", targetNamespace = "https://webservices.sabre.com/websvc")
...
@XmlSeeAlso({
    ...
    com.sabre.services.res.or.v1_0.ObjectFactory.class,
...
public interface TravelItineraryReadPortType {
     ...
     * @param body
     * @return
     *     returns com.sabre.webservices.sabrexml._2011._10.TravelItineraryReadRS
     */
    @WebMethod(operationName = "TravelItineraryReadRQ", action = "TravelItineraryReadRQ")
    @WebResult(name = "TravelItineraryReadRS", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
    public TravelItineraryReadRS travelItineraryReadRQ(
        ...
        @WebParam(name = "TravelItineraryReadRQ", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
        TravelItineraryReadRQ body);
