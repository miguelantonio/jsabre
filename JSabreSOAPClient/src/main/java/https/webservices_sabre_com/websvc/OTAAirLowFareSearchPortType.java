 ...
 * 
 */
@WebService(name = "OTA_AirLowFareSearchPortType", targetNamespace = "https://webservices.sabre.com/websvc")
...
public interface OTAAirLowFareSearchPortType {
     ...
     * @param body
     * @return
     *     returns com.sabre.webservices.sabrexml._2011._10.OTAAirLowFareSearchRS
     */
    @WebMethod(operationName = "OTA_AirLowFareSearchRQ", action = "OTA_AirLowFareSearchLLSRQ")
    @WebResult(name = "OTA_AirLowFareSearchRS", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
    public OTAAirLowFareSearchRS otaAirLowFareSearchRQ(
        ...
        @WebParam(name = "OTA_AirLowFareSearchRQ", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
