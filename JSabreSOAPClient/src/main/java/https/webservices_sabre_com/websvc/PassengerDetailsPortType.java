...
public interface PassengerDetailsPortType {
     ...
     * @param body
     * @return
     *     returns com.sabre.webservices.sabrexml._2011._10.PassengerDetailsRS
     */
    @WebMethod(operationName = "PassengerDetailsRQ", action = "PassengerDetailsRQ")
    @WebResult(name = "PassengerDetailsRS", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
    public PassengerDetailsRS passengerDetailsRQ(
        ...
        @WebParam(name = "PassengerDetailsRQ", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
