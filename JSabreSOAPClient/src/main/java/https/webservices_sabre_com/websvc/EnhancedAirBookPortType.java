...
public interface EnhancedAirBookPortType {
     ...
     * @param body
     * @return
     *     returns com.sabre.webservices.sabrexml._2011._10.EnhancedAirBookRS
     */
    @WebMethod(operationName = "EnhancedAirBookRQ", action = "EnhancedAirBookRQ")
    @WebResult(name = "EnhancedAirBookRS", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
    public EnhancedAirBookRS enhancedAirBookRQ(
        ...
        @WebParam(name = "EnhancedAirBookRQ", targetNamespace = "http://webservices.sabre.com/sabreXML/2011/10", partName = "body")
